...
public partial class WorldboxGame
{
    public class NameGenerators : ExtendLibrary<NameGeneratorAsset, NameGenerators>
    {
        ...
        private const string LandmassIslandTypes = "岛,屿,礁,渚,汀,岙";
        private const string LandmassContinentTypes = "洲,陆,土,原,野,泽";
        private const string LandmassMainlandTypes = "大陆,大洲,广陆,巨野,天陆,坤舆";
