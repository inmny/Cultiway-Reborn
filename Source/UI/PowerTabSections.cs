...
public static class PowerTabSections
{
    public const string InfoMain = "info.main";
    public const string WorldInfo = "world.info";
    ...
    public const string BuildingMain = "building.main";
    public const string DropMain = "drop.main";
    public const string DebugMain = "debug.main";
}
