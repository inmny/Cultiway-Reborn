...
namespace Cultiway.Content
{
    public class CultureTraits : ExtendLibrary<CultureTrait, CultureTraits>
    {
        ...
        protected override void OnInit()
        {
            ...
            // 与一切会改变区过滤/放置的布局 trait 互斥，保证密集填满 + Random + 聚集开启。
            HallHearth.group_id = "town_plan";
            HallHearth.path_icon = "cultiway/icons/traits/iconHallHearth";
            HallHearth.addOpposite("city_layout_pebbles");
            HallHearth.addOpposite("city_layout_stone_garden");
            HallHearth.addOpposite("buildings_spread");
            HallHearth.addOpposite("city_layout_the_grand_arrangement");
            HallHearth.addOpposite("city_layout_tile_wobbly_pattern");
            HallHearth.addOpposite("city_layout_tile_moonsteps");
        }
    }
}