...
public static class TacticalCombatSettings
{
    ...
    public const float VisibleDormantProbeMinInterval = 0.25f;
    public const float VisibleDormantProbeMaxInterval = 0.75f;
    public const float BackgroundDormantProbeMinInterval = 1.5f;
    public const float BackgroundDormantProbeMaxInterval = 3f;
...
internal sealed class CombatActorRuntime
{
    ...
    internal float LastProgressTargetDistance = float.MaxValue;
    internal WorldTile LastProgressGoalTile;
    ...
    internal CombatActionKey? StanceActionKey;
    internal CombatActionProfile? StanceProfile;
    internal long StanceTargetId;
