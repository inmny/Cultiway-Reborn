...
{
    private Action<T> _active_action;
    private Action<T> _create_action;
    private Action<T> _deactive_action;
    ...
    public void Return(T obj)
    {
        ...
        {
            var idx = _pool.FindIndex(a => a == obj);
            if (idx == -1)
            {
                _pool.Add(obj);
            }
    ...
    public T GetNext(int slibing_idx = -1)
    {
        T obj;
